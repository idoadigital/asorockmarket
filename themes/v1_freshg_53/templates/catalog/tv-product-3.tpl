...
*}
{strip}
    <div class="tvprduct-image-info-wrapper clearfix row product-3" data-product-layout="3">
        {hook h='displayProductTabVideo'}
        <div class="col-md-4 tv-product-details tv-product-page-content">
        ...
        <div class="col-md-4 tv-product-page-image">
            {block name='product_cover_thumbnails'}
            {include file='catalog/_partials/product-cover-thumbnails.tpl' ProdVar='custom'}
            {/block}
        </div>
        <div class="col-md-4 tv-product-page-content">
