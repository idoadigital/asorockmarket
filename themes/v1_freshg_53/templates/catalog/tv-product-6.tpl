...
*}
{strip}
    <div class="tvprduct-image-info-wrapper clearfix row product-6" data-product-layout="6">
        {hook h='displayProductTabVideo'}
        <div class="col-md-12 tv-product-page-image">
            {block name='product_cover_thumbnails'}
            {include file='catalog/_partials/product-cover-thumbnails.tpl'}
            {/block}
        </div>
        <div class="col-md-6 tv-product-page-content product-6">
