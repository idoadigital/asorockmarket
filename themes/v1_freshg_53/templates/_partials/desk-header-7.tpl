...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tvcmsdesktop-top-header-wrapper header-7" data-header-layout="7">
        <div class='tvcmsdesktop-top-header container-fluid'>
        ...
        <div class='container-fluid tvcmsdesktop-top-second hidden-md-down'>
            <div class="container">
                <div class="tvcmsdesktop-top-header-box">
                    <div class='col-md-2 col-lg-3 col-xl-4 col-sm-12 tvcms-header-logo-wrapper'>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4 col-sm-12 tvcmsheader-search">
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 tvcmsheader-nav-right">
                        <div class="tv-contact-account-cart-wrapper">
                            <div class="ttvcms-wishlist-icon">
                                {if $withData}{hook h='displayNavWishlistBlock'}{/if}
                            </div>
        ...
        c4.497,0,8.15,3.655,8.15,8.152C23.839,13.338,20.186,16.992,15.688,16.992"></path>
                                    ...
                                    <ul class="dropdown-menu tv-account-dropdown tv-dropdown">
                                        ...
                                        <li class="ttvcms-wishlist-icon hidden-lg-up">{hook h='displayNavWishlistBlock'}</li>
                                        <li class="tvheader-compare hidden-lg-up">{hook h='displayNavProductCompareBlock'}</li>
        ...
        <div class="tvcms-header-menu-offer-wrapper tvcmsheader-sticky">
            <div class="position-static tvcms-header-menu">
                <div class="container">
                    <div class='tvcmsmain-menu-wrapper col-lg-9 col-md-9'>
                    ...
                    <div class="tvcmsdesktop-contact col-lg-3 col-md-3">{if $withData}{hook h='displayNav1'}{/if}</div>
                </div>
            </div>
        </div>
    </div>
