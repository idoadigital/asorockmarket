...
{strip}
    ...
    <div class="footer-container tvcmsfooter-background-image footer-3" data-footer-layout="3" {if $FooterImageStatus}style="background-image: url('{$paths}{$FooterBackgroundImage}');" {/if}> <div class="container tvfooter-logo-link-wrapper">
        {if $page.page_name == 'index'}
