                                            ...
                                            <div class="tvnews-event-hoverbtn">
                                                <div class="tvblog-content-img">
                                                    ...
                                                    <picture>
                                                        ...
                                                        <img class="tvcmsblog_img img-responsive" src="{$tvcmsblgpst.post_img_blog_left}" alt="{$tvcmsblgpst.post_title}" width="{$smallwidthLeft}" height="{$smallheightLeft}">
                                                    </picture>
                                                </div>
                                               ...
                                               {* <span class="tvdate-time-icon"></span> *}{$tvcmsblgpst.post_date|date_format:'<p class="day_time tvday-time"><span>%d</span></p><p class="tvmonth-time"><span>%b</span></p>' nofilter}{* ,<p class="tvyear-time"><span>%Y</span></p> *}
                                            </div>
