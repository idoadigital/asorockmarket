    ...
    public function ajaxProcessUpdatePositions()
    {
        ...
        if (Validate::isLoadedObject($tvcmscategoryclass)) {
            if (isset($position) && $tvcmscategoryclass->updatePosition($way, $position)) {
                ...
                die('{"hasError" : true, errors : "Can not update tvcmscategoryclass position"}');
            }
        } else {
            die('{"hasError" : true, "errors" : "This tvcmscategoryclass can not be loaded"}');
        }
    }
}
