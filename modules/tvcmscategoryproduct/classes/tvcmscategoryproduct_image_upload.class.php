...
class TvcmsCategoryProductImageUpload extends Module
{
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tvcmscategoryproduct/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                ...
                $res2 = preg_match('/^demo_title.*$/', $old_file);

                if (file_exists(dirname(__FILE__).'./../views/img/'.$old_file) && $res != '1' && $res2 != '1') {
