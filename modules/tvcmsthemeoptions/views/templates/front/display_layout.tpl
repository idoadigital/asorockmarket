                                                ...
                                                <div class="tvtheme-layout-radio">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="tvlayout-radio-img">
                                                            ...
                                                            <img class="tvlayout-image" src="{$fields_data['layout_img_path']}hlayouts/{$header_name}.png" alt="header-layout" data-layout="{$header_name}" />
                                                ...
                                                <div class="tvtheme-layout-radio">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="tvlayout-radio-img">
                                                            ...
                                                            <img class="tvlayout-image" src="{$fields_data['layout_img_path']}hlayouts/{$header_mobile_name}.png" alt="header-mobile-layout" data-layout="{$header_mobile_name}" />
                                                            <p class="tvlayout-title">{l s='Header' mod='tvcmsthemeoptions'} {$smarty.foreach.index.index+1}</p>
                                                        </label>
                                                    </div>
                                                    {/foreach}
                                                ...
                                                <div class="tvtheme-layout-radio">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="tvlayout-radio-img">
                                                            ...
                                                            <img class="tvlayout-image" src="{$fields_data['layout_img_path']}flayouts/{$footer_name}.png" alt="footer-layout" data-layout="{$footer_name}" />
