                                    ...
                                    <label for="radioTheme1" class="theme-1">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#4285f4;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#28a745;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 1' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme2" name="radioTheme" data-color="#ffd741" data-color-two="#e40046" value="theme2">
                                    <label for="radioTheme2" class="theme-2">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#ffd741;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#e40046;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 2' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme3" name="radioTheme" data-color="#064169" data-color-two="#f47124" value="theme3">
                                    <label for="radioTheme3" class="theme-3">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#064169;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#f47124;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
                                        <span class="tvtheme-label">{l s='Theme 3' d='Shop.Theme.Global'}</span>
                                    </label>
                                    <input type="radio" id="radioTheme4" name="radioTheme" data-color="#C80436" data-color-two="#333333" value="theme4">
                                    <label for="radioTheme4" class="theme-4">
                                        <span>
                                            <svg class="primary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#C80436;" points="0,0 0,47 64.234,47 89.681,0  " />
                                                </g>
                                            </svg>
                                            <svg class="secondary-color" version="1.1" id="Layer_1" x="0px" y="0px" width="89.681px" height="47px" viewBox="0 0 89.681 47" style="enable-background:new 0 0 89.681 47;" xml:space="preserve">
                                                <g>
                                                    <polygon style="fill:#333333;" points="89.681,0 25.445,0 0,47 89.681,47     " />
                                                </g>
                                            </svg>
                                        </span>
