...
class TvcmsTabProducts extends Module
{
    ...
    public function createDefaultData()
    {
        ...
        Configuration::updateValue('TVCMSTABPRODUCTS_FEATURED_PROD_IMAGE_SIDE', 'right');
        Configuration::updateValue('TVCMSTABPRODUCTS_FEATURED_PROD_IMAGE_STATUS', 1);
        ...
        Configuration::updateValue('TVCMSTABPRODUCTS_NEW_PROD_IMAGE_STATUS', 1);
        ...
        Configuration::updateValue('TVCMSTABPRODUCTS_BEST_SELLER_PROD_IMAGE_STATUS', 1);
