...
class TvcmsTestimonialImageUpload extends Module
{
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tvcmstestimonial/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                ...
                $res2 = preg_match('/^demo_img_.*$/', $old_file);
                $res3 = preg_match('/^demo_sing_img_.*$/', $old_file);
