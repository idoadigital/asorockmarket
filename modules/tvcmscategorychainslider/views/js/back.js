...
$(document).ready(function(){
	...
	$('.tvcmscategorychainslider .tvcmsdelete').click(function(e){
		e.preventDefault();
	...
	function removeTags(){
    	setTimeout(function() {
          $(".tvcmscategorychainslider-position-update").remove();
        }, 3000);
    }

	var url = baseDir + "modules/tvcmscategorychainslider/ajax.php";
    var obj = $(document).find('body');
    $(".tvcmscategorychainslider tbody").sortable({
        opacity: 0.6,
        cursor: 'move',
        update: function() {
            ...
            $.post(url, order, function(data) {
                ...
                if (result == 'right') {
                    var tags = '';
                    tags += '<div id="growls" class="default tvcmscategorychainslider-position-update"><div class="growl growl-notice growl-medium">';
