                ...
                <div class="col-lg-12 tvcms-layout-wrapper">
                    ...
                    {assign var="desk_name" value="desk-header-{$i}"}
                        <div class="col-lg-4 tvmcs-radio-manage">
                            ...
                            <label for="header_{$i}_layout_configuration"><img src="{$fields_value['layout_img_path']}hlayouts/{$desk_name}.png"></label>
                        </div>
                    {/foreach}
                </div>
                    <p class="help-block">
            ...
            <div class="form-group">
                <div class="col-lg-12 tvcms-layout-wrapper">
                     ...
                     <div class="col-lg-4 tvmcs-radio-manage"> 
                        ...
                        <label for="header_mobile_{$i}_layout_configuration"><img src="{$fields_value['layout_img_path']}hlayouts/{$mob_name}.png"></label>
                    </div>
                    {/foreach}
            ...
            <div class="form-group">
                <div class="col-lg-12 tvcms-layout-wrapper">
                    ...
                    <div class="col-lg-4 tvmcs-radio-manage">
                        ...
                        <label for="footer_{$i}_layout_configuration"><img src="{$fields_value['layout_img_path']}flayouts/{$footer_prod_name}.png"></label>
                    </div>
                    {/foreach}
                    {*
                    <div class="col-lg-2 tvmcs-radio-manage">
