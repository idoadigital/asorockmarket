...
class TvcmsMegaMenuRowClass extends ObjectModel
{
    public $id_tvcmsmegamenu;
    public $class;
    public $active;
    public static $definition = array(
        'table' => 'tvcmsmegamenu_row',
        'primary' => 'id_row',
        'multilang_shop' => true,
        'fields' => array(
            'id_tvcmsmegamenu' => array(
                'type' => self::TYPE_INT,
                'shop' => true,
    ...
    public function __construct($id_row = null, $id_lang = null, $id_shop = null, Context $context = null)
    {
        ...
        Shop::addTableAssociation('tvcmsmegamenu_row', array('type' => 'shop'));
    }
