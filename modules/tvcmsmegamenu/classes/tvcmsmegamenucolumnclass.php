...
class TvcmsMegaMenuColumnClass extends ObjectModel
{
    public $id_row;
    public $width;
    public $class;
    ...
    public function __construct($id_column = null, $id_lang = null, $id_shop = null, Context $context = null)
    {
        ...
        Shop::addTableAssociation('tvcmsmegamenu_column', array('type' => 'shop'));
    }
    ...
    public function getPositionByColumn($id_col)
    {
        ...
        return Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow('
            SELECT ms.`position`
            FROM '._DB_PREFIX_.'tvcmsmegamenu_column_shop ms
