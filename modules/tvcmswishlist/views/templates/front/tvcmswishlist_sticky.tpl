...
<div class="tvsticky-wishlist">
    <a class="wishtlist_top tvwishlist-top" href="{$link->getModuleLink('tvcmswishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}">
        <i class='material-icons'>&#xe87d;</i>

        <div class="tvwishlist-sticky-name">
            <span>{l s='Wishlist' mod='tvcmswishlist'}</span>
            <span class="cart-wishlist-number tvwishlist-number">({l s='%s' sprintf=[$count_product] mod='tvcmswishlist'})</span>
        </div>
    </a>
</div>
