...
<div class="tvcmsmobile-view-wishlist">
    <a class="wishtlist_top tvmobile-view-wishlist" href="{$link->getModuleLink('tvcmswishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}">
    	<span class="tvmobile-view-wishlist-name">{l s='Wishlist ' mod='tvcmswishlist'}</span>
         {* <i class='material-icons'>&#xe87d;</i> *}
        <div class="tvmobile-view-wishlist-count">
            <span>( </span><span class="cart-wishlist-number tvmobile-view-wishlist-number">{l s='%s' sprintf=[$count_product] mod='tvcmswishlist'}</span><span> )</span>
        </div>
    </a>
</div>
{/strip}