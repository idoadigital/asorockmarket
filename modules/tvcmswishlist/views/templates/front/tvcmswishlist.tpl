...
<div id="wishlist_block" class="block account">
	<h4 class="title_block">
		<a href="{$link->getModuleLink('tvcmswishlist', 'mywishlist', array(), true)|addslashes|escape:'htmlall':'UTF-8'}" title="{l s='My wishlists' mod='tvcmswishlist'}" rel="nofollow">{l s='Wishlist' mod='tvcmswishlist'}</a>
	</h4>
	<div class="block_content">
		...
		{/if}
			<a href="{$link->getModuleLink('tvcmswishlist', 'mywishlist', array(), true)|addslashes|escape:'htmlall':'UTF-8'}" title="{l s='My wishlists' mod='tvcmswishlist'}" rel="nofollow">&raquo; {l s='My wishlists' mod='tvcmswishlist'}</a>
		</p>
	</div>
</div>
{/strip}