...
class TvcmsNewsLetterPopupImageUpload extends Module
{
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tvcmsnewsletterpopup/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $res = preg_match('/^demo_img.*$/', $old_file);
                $res2 = preg_match('/^demo_bg_img.*$/', $old_file);
