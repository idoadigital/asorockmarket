...
$(document).ready(function(){
	$('.tvcmsbrandlist .tvcmsdelete').click(function(e){
		e.preventDefault();
	...
	var url = baseDir + "modules/tvcmsbrandlist/ajax.php";
    ...
    $(".tvcmsbrandlist tbody").sortable({
        ...
        update: function() {
            ...
            $.post(url, order, function(data) {
                ...
                if (result == 'right') {
                    var tags = '';
                    tags += '<div id="growls" class="default tvcmsbrandlist-position-update"><div class="growl growl-notice growl-medium">';
