...
/* Smarty version 3.1.43, created on 2022-05-05 14:35:24
  from '/home/t87ihn5k7gt9/public_html/ecommerce/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_6273e0ac3668b3_04147053',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f42abbe810605d91975828ba6ab5a312d83a4d99' => 
    array (
      0 => '/home/t87ihn5k7gt9/public_html/ecommerce/modules/tvcmscustomsetting/views/templates/front/display_custom_social.tpl',
      1 => 1651641689,
      2 => 'file',
    ),
  ),
...
function content_6273e0ac3668b3_04147053 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
?>
    <?php if ($_smarty_tpl->tpl_vars['LeftStickyStatus']->value) {
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_6530512876273e0ac3500f9_38424792', 'block_social');
}
...
/* {block 'block_social'} */
class Block_6530512876273e0ac3500f9_38424792 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'block_social' => 
  array (
    0 => 'Block_6530512876273e0ac3500f9_38424792',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="block-social tv-footer-social-icon wow slideInLeft"><div class="tv-footer-social-icon-wrapper"><div class="tv-footer-social-icon-inner"><?php if (!empty(Configuration::get('BLOCKSOCIAL_FACEBOOK',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvfacebook-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_FACEBOOK'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_TWITTER',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvtwitter-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_TWITTER'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_RSS',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvrss-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_RSS'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_YOUTUBE',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvyoutube-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_YOUTUBE'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_PINTEREST',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvpinterest-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_PINTEREST'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_VIMEO',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvvimeo-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_VIMEO'), ENT_QUOTES, 'UTF-8');?>
...
if (!empty(Configuration::get('BLOCKSOCIAL_INSTAGRAM',$_smarty_tpl->tpl_vars['language']->value['id']))) {?><div class="tvblock-social-content tvinstagram-wrapper"><a href="<?php echo htmlspecialchars(Configuration::get('BLOCKSOCIAL_INSTAGRAM'), ENT_QUOTES, 'UTF-8');?>
